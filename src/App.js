      ...
      <div className='matrixContainer'>
        ...
        <div className="matrix" id='e-commerce'>
          ...
          <div class="matrixTxt">
            ...
            <br/><br/>
            <a onClick={()=> redirection("https://github.com/GazuaDev8417/e-commerce_web", 'e-commerce')}>
              Respositório Frontend
            </a>
            <br/>
            <a onClick={()=> redirection("https://github.com/GazuaDev8417/e-commerce_server", 'e-commerce')}>
        ...
        <div className="matrix" id='loja-de-servicos'>
          ...
          <div class="matrixTxt">
            ...
            <a onClick={()=> redirection("https://github.com/GazuaDev8417/loja_de_servicos-web", 'loja-de-servicos')}>
              Repositório Frontend
            </a><br/>
            <a onClick={()=> redirection("https://github.com/GazuaDev8417/loja_de_servicos-server", 'loja-de-servicos')}>
              Repositório Backend
            </a><br/>
            <a onClick={()=> redirection("https://github.com/GazuaDev8417/loja_de_servicos-mobile", 'loja-de-servicos')}>
              Repositório Mobile
            </a>                        
          </div>
        </div>
        ...
        <div className="matrix" id='fakebank'>
          ...
          <div class="matrixTxt">
            ...
            <br/>
            <a onClick={()=> redirection("https://github.com/GazuaDev8417/fakebank-web", 'fakebank')}>
              Repositório Frontend
            </a><br/>            
            <a onClick={()=> redirection("https://github.com/GazuaDev8417/fakebank-server", 'fakebank')}>
              Repositório Backend
            </a><br/>            
            <a onClick={()=> redirection("https://github.com/GazuaDev8417/fakebank-mobile", 'fakebank')}>
              Repositório Mobile
            </a>
          </div>
        </div>
        ...
        <div className="matrix" id='ifuture'>
          ...
          <div class="matrixTxt">
            ...
            <a onClick={()=> redirection("https://github.com/GazuaDev8417/ifuture-web", 'ifuture')} >
              Repositório Frontend
            </a><br/>
            <a onClick={()=> redirection("https://github.com/GazuaDev8417/ifuture-mobile", 'ifuture')}>
              Repositório Mobile
            </a>
          </div>
        </div>
